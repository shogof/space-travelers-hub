...
function MyProfile() {
  ...
  return (
    <div className="border-purple-500 border-2 w-2/4 mx-auto p-8 h-auto">
      ...
      <div className="mb-8 border-purple-900 outline-double border-2 py-4">
      ...
      <div className="border-purple-500 border-2 py-4 outline-double">
        <h2 className="text-4xl mb-8 text-center">My Dragons</h2>
        <ul>
